      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item nav-profile border-bottom">
            <a href="{{route('dashboard')}}" class="nav-link flex-column">
              <div class="nav-profile-image">
                <img src="{{url('assets/images/faces/SolunarGlyph.png')}}" alt="profile" />
                <!--change to offline or busy as needed-->
              </div>
              <div class="nav-profile-text d-flex ms-0 mb-3 flex-column">
                <span class="font-weight-semibold mb-1 mt-2 text-center">{{$user->name}}</span>
                <!--<span class="text-secondary icon-sm text-center">{{$user->email}}</span>-->
              </div>
            </a>
          </li>
